...
const BtnFilterFund = styled(Button)({
  textAlign: 'left',
  whiteSpace: 'pre-wrap',
  fontSynthesis: 'none',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TitelSection>
          <TitelSectionBox variant='h6' sx={{flexGrow: 1}}>
            Productos Activos{' '}
          </TitelSectionBox>
          <IteractionAssetsFilt>
            <BtnFilterFund sx={{color: 'rgba(148, 191, 225, 1)'}}>
              Fondos
            </BtnFilterFund>
            <Divaider>|</Divaider>
        ...
        {portfolio != null ? (
          ...
          <SectionNoProduct>
            <ContetNoProduct>
              ...
              <BodyTextNoProduct>
                <TitelNopProduct fontSize={'clamp(12px, 5vw, 26px)'}>
                  Creemos en ti
                </TitelNopProduct>
                <ParrafoNoProduct fontSize={'clamp(12px, 2vw, 16px)'}>
                  La base de una buena inversión es el conocimiento
                </ParrafoNoProduct>
                <BtnCarga
                  variant='text'
                  sx={{fontSize: 'clamp(10px, 1vw, 14px)'}}
                >
