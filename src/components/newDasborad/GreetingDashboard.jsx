...
export const GreetingDashboard = ({ name }) => {
    return (
        <TitelDashboards>
            <TitelType sx={{ fontSize: 'clamp(24px, 3vw, 28px)' }}>Hola <NameSection sx={{ fontSize: 'clamp(24px, 3vw, 28px)' }} component="span">{name}</NameSection>, que bueno verte de vuelta</TitelType>
