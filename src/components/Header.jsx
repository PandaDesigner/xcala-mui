...
const Header = ({ totalCaja, disponibleCaja, transitoCaja }) => {
    return (
        <Stack flexDirection={"column"} position={{ xs: "fixed", md: "flex" }} sx={{ top: "0", left: "0", right: "0" }}>
            <Stack direction={"column"} sx={{
                ...
                <Stack marginX={{ xs: "0", sm: "100px" }} justifyContent={{ xs: "start", sm: "center" }}>
                    ...
                    <Typography variant="body1" fontWeight={300} textAlign={{ xs: "center", sm: "center" }} color="#fff">Total en Caja</Typography>
                </Stack>

                <CoinFlotin disponibleCaja={disponibleCaja} transitoCaja={transitoCaja} />
            </Stack>
