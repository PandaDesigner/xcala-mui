...
export const BtnGroupFix = () => {
    return (
        <Stack position={{ xs: "Fixed", md: "none" }} bottom={"31px"} left={"0"} right={"0"} >
            <BtnContainer display={{ xs: "flex", md: "none" }} maxHeight={"70px"}>
                <BtnGroup gap={0} backgroundColor={"#1E22AA"} maxHeight={"70px"}  >
                    ...
                    <Button
                        ...
                        color="primary"
                        size="large"
                        sx={{ width: "100%", boxShadow: "none", textTransform: 'none', paddingY: "16px" }}
                        disableElevation
                        disableRipple
                    >Recargar</Button>
                    <Button
                ...
                <Box sx={{ "& > button": { m: 0 }, marginTop: "-95px", boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)", borderRadius: "100%", "& > button:hover": { backgroundColor: "#e2e2e2" } }} zIndex={2} >
                    <IconButton
                        color="primary"
                        size="large"
