...
export const SelectRescueItem = ({
  mountFund = 10000,
  lableParcialRescue = 'Rescate parcial 50% del valor del Portafolio',
  lableTotalRescue = 'Rescate total',
      ...
      <FormControl sx={{ width: '100%' }} variant="standard">
        ...
        >
          <FormControlLabel
            ...
            value={true}
            control={<Radio />}
            label={lableParcialRescue}
          />
          <FormControlLabel
            sx={{ color: '#848484' }}
            value={false}
            control={<Radio />}
            label={lableTotalRescue}
          />
        </RadioGroup>
        ...
        />
        <BoxSectionPymen flexDirection={'row'} gap={0.1}>
          <BoxContent
            sx={{
